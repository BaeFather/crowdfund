...
$page_title = "대상기간내 첫투자자 누적투자금액 ".price_cutting($target_amount)."원 이상 투자자 현황 (".preg_replace("/-/", ".", $sdate)."~".preg_replace("/-/", ".", $edate).")";
