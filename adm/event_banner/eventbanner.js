// 아이디 체크
var smsHelloProcessUrl = "/adm/event_banner/process.php";
...
function check_w_form(fmname, event)
{
    ...
    formData.append('i_file[]', $("input[name='i_file[]']")[0].files[0]);
		formData.append('s_file[]', $("input[name='s_file[]']")[0].files[0]);
