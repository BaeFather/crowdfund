...
IF($idx)
{
	...
	$strColumn	=	ARRAY(
							...
							"mkind","loankind","loanother","vdate","hellobase","hellofee","ifile","honumber","kbquote"
					);
	...
	(
		...
		(SELECT ".$intSeqName.",laddr,pname,crating,comday,hholds,ddmoney,bsmoney,mdate,kbarea,kbprice,kbllimit,kbcharter,examount,maxbond,ltvmoney,ltvkind,rowner,tenant,content,reg_date,ipaddr,recyn,hideyn,hmseq,mb_no,productyn,mkind,loankind,loanother,vdate,hellobase,hellofee,ifile,IFNULL(honumber,'') as honumber,IFNULL(kbquote,'') as kbquote FROM hloan_content) st1 JOIN hloan_member st2 ON st1.hmseq=st2.hmseq
	) t1";
...
?>
	<table style="max-width:1000px;border-collapse:collapse;">
		...
		<tr>
			<th style="width:150px;border:1px solid #AAA;">KB시세URL</th>
			<td colspan="3" style="width:350px;border:1px solid #AAA;padding-left:15px">
				<?php ECHO INPUT_FORM($strInputText1,"kbquote","input04","","",$kbquote);?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="width:350px;border:1px solid #AAA;padding-left:15px"><?php ECHO fn_mdate_pro($mkind,$mdate);?></td>
			<th style="width:150px;border:1px solid #AAA;">대출구분</th>
			<td style="width:350px;border:1px solid #AAA;padding-left:15px">
			<?php ECHO fn_general_select($loankind,"txt",fn_loankind(),"","loankind","class='radio03'","");?>
			<?php IF($loankind == "2") { ECHO "[".$loanother."] 질권대출 "; } ?>
			</td>
		</tr>
		<tr>
			<th style="width:150px;border:1px solid #AAA;">기표희망일</th>
			<td colspan="3" style="width:350px;border:1px solid #AAA;padding-left:15px">
			<?php ECHO INPUT_FORM($strInputText1,"vdate","input02","","required itemname='기표희망일'",$vdate);?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th style="width:150px;border:1px solid #AAA;">헬로펀딩 기준금리 (%)</th>
			<td style="width:350px;border:1px solid #AAA;padding-left:15px"><?php ECHO INPUT_FORM($strInputText1,"hellobase","text01","","",$hellobase);?></td>
			<th style="width:150px;border:1px solid #AAA;">플랫폼 이용료 (원)</th>
			<td style="width:350px;border:1px solid #AAA;padding-left:15px"><?php ECHO INPUT_FORM($strInputText1,"hellofee","text01","","",f_number($hellofee));?></td>
		</tr>
		<tr>
			<th style="width:150px;border:1px solid #AAA;">특이사항</th>
			<td colspan="3" style="width:350px;border:1px solid #AAA;padding-left:15px">
				<?php ECHO INPUT_FORM($strInputTextarea,"content","text01","","",$content);?>
			</td>
		</tr>
		<tr>
			<th style="width:150px;border:1px solid #AAA;">심사</th>
			<td colspan="3" style="width:350px;border:1px solid #AAA;padding-left:15px">
<?php
...
?>
		...
		<tr>
			...
			<td style="width:350px;border:1px solid #AAA;padding-left:15px"><?php ECHO fn_general_select($productyn,"txt",fn_product_hello(),":헬로펀딩 상품:","productyn","class='input02'","");
				?></td>
			<th style="width:150px;border:1px solid #AAA;">호번</th>
			<td style="width:350px;border:1px solid #AAA;padding-left:15px"><?php ECHO INPUT_FORM($strInputText1,"honumber","text01","","",$honumber);?></td>
		</tr>
	</table>
