...
.m3stats_align_c {text-align:right; padding-right:4px;}

.tableX td{ padding:2px 4px; font-size:13px; }
</style>
...
<div id="div_m3sq" style="margin-left:20px; width:920px;">
...
$(document).ready(function(){
	setInterval(function() {
		$.ajax({
			url : "./ajax_m3stats.php",
			success: function(data) {
				$('#div_m3sq').empty();
				$('#div_m3sq').append(data);
			}
		});
	}	, 30*1000);
});
