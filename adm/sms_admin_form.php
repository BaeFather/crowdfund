...
$html_title = "SMS 관리자발송";
$g5['title'] = $html_title.' 설정';

// SMS 정보
if(isset($_GET['init']) && $_GET['init'] == 1) {
	$sql = "SELECT * FROM `g5_sms_admininfo_default` ORDER BY send_type_no ASC";
	$g5['title'] .= ' (최초설정값이 로드됨)';
}else {
	$sql = "SELECT * FROM `g5_sms_admininfo` ORDER BY send_type_no ASC";
}
...
<form name="frmsmsform" id="frmsmsform" action="./sms_admin_update.php" method="post" enctype="MULTIPART/FORM-DATA" >
<?php 
...
<div class="btn_confirm01 btn_confirm">
	...
	<input type="button" value="최초설정 불러오기" class="btn_submit" onclick="document.location.href='./sms_admin_form.php?init=1';" style="background-color:#383A3F;">
</div>
