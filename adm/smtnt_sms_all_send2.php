...
<div class="tbl_frm01 tbl_wrap tbl_head02">
	...
	<form name="fmember" id="fmember" action="/adm/smtnt_sms_all_send2.php" method="post" enctype="multipart/form-data">
	...
	<form name="fsms" id="fsms" action="/adm/smtnt_sms_all_send2_proc.php" method="post" enctype="multipart/form-data">
...
$('#btn_delete').click(function() {
	...
	fsms.mode.value = 'aaa_number_delete';
