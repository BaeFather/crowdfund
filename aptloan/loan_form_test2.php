...
<script type="text/javascript">
	...
	grecaptcha.ready(function() {
		// reCAPTCHA가 실행될 때 더 많은 제어를 원하면 object에서 execute메서드 사용, action 보호하고자 하는 각 행동 요청
		grecaptcha.execute('6LdBq8UaAAAAAGHv6kxJ2lQ5gPcv5-e7E7scf9FR', {action: 'submit'}).then(function(token) {  
			// 토큰을 받아다가 g-recaptcha에 값을 넣음
...
if ($_SERVER["REMOTE_ADDR"]=="220.117.134.247" or $_SERVER["REMOTE_ADDR"]=="220.117.134.166") {
		?>
			<br/><a href="javascript:void(0);" id="btn2" OnClick="check_request_form2('regfm',event);" data-action="submit">대출신청하기2</a>

			<!--button class="g-recaptcha" data-sitekey="reCAPTCHA_site_key" data-callback='gogo' data-action='click'>대출신청하기3</button-->
			<button class="gggg-recaptcha" data-sitekey="reCAPTCHA_site_key" data-callback='onSubmit' data-action='submit'>Submit</button>
