...
if ($bo_table=="recruit") goto_url(G5_URL.'/company/recruit/recruit.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr);
else goto_url('./board.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr);
?>
