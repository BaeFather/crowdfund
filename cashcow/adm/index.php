...
?>
		...
		<div id="content" style="position:absolute; height:100%; margin-top:0; background-color:#666666; width:100%;">
			<div class="content investment" style="width:98%;margin:150px auto;">
				...
				<div style="width:440px; height:310px; margin:0 auto; background-image:url('ams_gate_bg.gif');">
					...
					<ul style="list-style:none;">
						...
						<li style="margin-left:150px; margin-top:20px;"><img id="submit_btn" src="login.gif" style="cursor:pointer;" width="144" height="38"></li>
					</ul>
					</form>
				</div>
	...
	if($('#adminid').val()=='') { alert('ID를 입력하십시요'); $('#adminid').focus(); }
		...
		$.ajax({
			...
			success:function(data) {
				if(data=='SUCCESS') {
					$(location).attr('href', 'member_status.php');
				}
				else {
					alert('인증에 실패 하였습니다.');
				}
