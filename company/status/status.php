...
<link href="status.css?ver=3" rel="stylesheet">
...
<div id="web">
	...
	<table class="invest-data" id="inState">
		<thead>
			<tr>
				<th>누적 투자 금액 <span>(원)</span></th>
				<th>투자 잔액 <span>(원)</span></th>
				<th>연체율 <span>(%)</span></th>
				<th>연체건수 <span>(건)</span></th>
			</tr>
		</thead>
	...
	<table class="disposal" id="bsell">
		...
		<thead>
			<tr>
				<th>상품 유형</th>
				<th>상품 호번</th>
				<th style="text-align: right;">채권 원금 <span>(원)</span></th>
				<th style="text-align: right;">매각 금액 <span>(원)</span></th>
	...
	<div class="wrap_info">
		<table class="info">
			<tbody>
				<tr>
					<th>헬로펀딩 안내사항</th>
					<!--<td><a href="hellofundinginfo.pdf" target="_blank"><img src="img/view.png"></a></td>-->
