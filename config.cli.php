...
if( @$_SERVER['HTTP_USER_AGENT'] ) {
	$cdomain = preg_replace("/(www\.|www1\.|www2\.)/", ".", $_SERVER['HTTP_HOST']);
	$cdomain = preg_replace("/\:443/", "", $cdomain);
	define('G5_COOKIE_DOMAIN',  $cdomain);
}
...
define('API_URL',  'https://ext.hellofunding.co.kr');
//==============================================================================
...
if(defined('G5_SMTP_USE_EXT') && G5_SMTP_USE_EXT) {
	...
	define('G5_SMTP_ID',     'hellofunding@gmail.com');
	define('G5_SMTP_PW',     'hello2018win');
	...
	*/
	...
	define('G5_SMTP_ID',     'hellofunding@naver.com');
	define('G5_SMTP_PW',     'hello2018win');
	...
	*/
	...
	define('G5_SMTP_ID',     'cs@hellofunding.co.kr');
	define('G5_SMTP_PW',     'hellofun12!@');
...
//include_once('/home/crowdfund/public_html/data/office_ipconfig.php');		//**** 오피스IP 정의 (CLI는 불필요) ****//

include_once('/home/crowdfund/public_html/config.service.php');		//**** 헬로펀딩 서비스 환경설정 ****//
