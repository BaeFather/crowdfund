...
define('G5_COOKIE_DOMAIN',  preg_replace("/(www\.|www1\.|www2\.|www-stg\.)/", ".", @$_SERVER['HTTP_HOST']));
...
if(defined('G5_SMTP_USE_EXT') && G5_SMTP_USE_EXT) {
	...
	define('G5_SMTP',        $_ENV['SMTP_HOST']);
	define('G5_SMTP_PORT',   $_ENV['SMTP_PORT']);		// (465|587)
	define('G5_SMTP_ID',     $_ENV['SMTP_ID']);
	define('G5_SMTP_PW',     $_ENV['SMTP_PASSWORD']);
