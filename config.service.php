...
$CONF['niceUid'] = $_ENV['NICE_ACCOUNT_UID'];				// 고객사에 부여한 구분 id
$CONF['svcPwd']  = $_ENV['NICE_ACCOUNT_PASSWORD'];				// 고객사에 부여한 서비스 이용 패스워드

// 나이스평가정보 실명 확인 모듈 서비스 계정
$CONF['niceSitecode']   = $_ENV['NICE_SITECODE'];						// NICE로부터 부여받은 사이트 코드
$CONF['niceSitepasswd'] = $_ENV['NICE_SITEPASSWORD'];			// NICE로부터 부여받은 사이트 패스워드

// 신한은행 계좌발급용
$CONF['VACT_COMPANY_CODE']['HLP'] = '20007212';		// 예치금신탁계좌 기관코드 (핀테크)
$CONF['VACT_COMPANY_CODE']['HLC'] = '20007213';		// 상환용가상계좌 기관코드 (크라우드대부)
...
// [중앙기록관리] API 계정
$CONF['p2pctr']['host'] = $_ENV['P2PCTR_HOST'];
$CONF['p2pctr']['code']	= $_ENV['P2PCTR_CODE'];				// 헬로핀테크 기관코드(상용)
// [중앙기록관리] API 점검시간
...
$CONF['useb']['token_email']  = $_ENV['USEB_TOKEN_EMAIL'];
$CONF['useb']['token_passwd'] = $_ENV['USEB_TOKEN_PASSWORD'];
...
// 상환계좌등록용 투자마무리 회원ID
$CONF['INVEST_FINISHER']  = 'hellosiesta';		// 일반상품용
$CONF['INVEST_FINISHER2'] = 'hellofintech';		// 기타비용(수수료) 처리상품 전용용 : 핀테크 법인계정
