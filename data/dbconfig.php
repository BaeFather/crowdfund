...
$use_proxy = false;		// 프록시 서버 경유 여부 (API 상용서버 기본값 true)


if($use_proxy) {
	if( preg_match("/(\/investment\/investment\_proc\.php|\/deposit\/withdrawal\_request\_proc\.php|\/investment\/inv\_sms\_admin\.php|\/schedule\_work\/invest\_finish)/i", @$_SERVER['PHP_SELF']) ) {
		$use_proxy = false;
	}
}
...
if($use_proxy) {
	...
	// 메인 DB
	define('G5_MYSQL_HOST',     $_ENV['DB_PROXY_HOST']);
	define('G5_MYSQL_PORT',     $_ENV['DB_PROXY_PORT']);
	define('G5_MYSQL_USER',     $_ENV['DB_USER']);
	define('G5_MYSQL_PASSWORD', $_ENV['DB_PASSWORD']);
	define('G5_MYSQL_DB',       $_ENV['DB_NAME']);
	define('G5_MYSQL_SET_MODE', true);

	// 개인정보 DB
	define('G5_MYSQL_HOST2',     $_ENV['DB2_PROXY_HOST']);
	define('G5_MYSQL_PORT2',     $_ENV['DB2_PROXY_PORT']);
	define('G5_MYSQL_USER2',     $_ENV['DB2_USER']);
	define('G5_MYSQL_PASSWORD2', $_ENV['DB2_PASSWORD']);
	define('G5_MYSQL_DB2',       $_ENV['DB2_NAME']);
	...
	// 메인 DB
	define('G5_MYSQL_HOST2',     $_ENV['DB_HOST']);
	define('G5_MYSQL_PORT2',     $_ENV['DB_PORT']);
	define('G5_MYSQL_USER2',     $_ENV['DB_USER']);
	define('G5_MYSQL_PASSWORD2', $_ENV['DB_PASSWORD']);
	define('G5_MYSQL_DB2',       $_ENV['DB_NAME']);
	define('G5_MYSQL_SET_MODE2', true);

	// 개인정보 DB
	define('G5_MYSQL_HOST2',     $_ENV['DB2_HOST']);
	define('G5_MYSQL_PORT2',     $_ENV['DB2_PORT']);
	define('G5_MYSQL_USER2',     $_ENV['DB2_USER']);
	define('G5_MYSQL_PASSWORD2', $_ENV['DB2_PASSWORD']);
	define('G5_MYSQL_DB2',       $_ENV['DB2_NAME']);
	define('G5_MYSQL_SET_MODE2', true);
