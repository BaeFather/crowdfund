...
$sql = "SELECT COUNT(po_id) AS cnt_id FROM g5_point WHERE mb_no = '".$member['mb_no']."'";
$row = sql_fetch($sql);
...
?>
		<tr onMouseOver="this.bgColor='#F7F7F7'" onMouseOut="this.bgColor=''">
			...
			<td style="text-align:left;color:<?=$fcolor?>;font-size:12px"><?=$LIST[$i]['po_content']?></td>
...
<div id="paging_span" class="mt10 mb20 point_log_paging">
