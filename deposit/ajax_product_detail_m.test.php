...
?>
	<div style="width:100%;padding:2px;margin-bottom:2px; border-radius:4px; background:<?=$bgcolor?>;color:#FFF;text-align:center; font-size:12px"><b><?=$LIST[$i]['repay_title']?></b></div>
	<div class="mb10">
		<table class="tblXX">
			<colgroup>
				<col width="40%">
