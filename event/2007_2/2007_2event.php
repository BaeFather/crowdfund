...
$event_start_date = "2020-07-01";
$event_end_date   = "2020-07-31";
...
<link href="2007_2event.css" rel="stylesheet">
...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		<div class="event1">진행중 이벤트<span>2020.07.01 ~ 2020.07.31</span></div>
		<div class="event2">헬로펀딩 7월 주택담보상품 투자자 이벤트</div>
		<div class="event3"><img src="img/banner.jpg" alt="헬로펀딩 7월 투자자 이벤트"></div>
		<div class="event4" id="event1">헬로펀딩 7월 주택담보상품 투자자 이벤트</div>
		<div class="event5">
			<p class="event_num">#이벤트 1</p>
			<p>7월 오픈 [주택담보상품]에 누적 500만원 이상 투자 시<br><span>국산 덴탈 마스크 1 Box(50매) 증정</span></p>
		</div>
		<div class="event5">
			<p class="event_num">#이벤트 2</p>
			<p>7월 오픈 [주택담보상품]에 누적 1,000만원 투자 시<br><span>국산 덴탈 마스크 1 Box(50매) 추가 증정</span></p>
		</div>

		<div class="event8">
			<ul>
				<li class="title">참여기간</li>
				<li class="text">2020년 07월 01일 ~ 2020년 07월 31일</li>
			</ul>
		</div>
		<div class="event8">
			<ul>
				<li class="title">참여방법</li>
				<li class="text">7월 오픈 <span>주택담보상품</span>에 500만원 ~ 1,000만원 투자 시 자동 참여</li>
			</ul>
		</div>	
		<div class="event7">
			<ul>
...
<!--------------------모바일----------------------------------------------------------->
	...
	<div id="event_m">
		<div class="m_event1">진행중 이벤트<span>2020.07.01 ~ 2020.07.31</span></div>
		<div class="m_event2">헬로펀딩 7월 투자자 이벤트</div>
		<div class="m_event3"><img src="img/m_banner.jpg" alt="헬로펀딩 7월 투자자 이벤트">

		</div>
		<div class="m_event4">
			<ul>
				<li class="1_title">헬로펀딩 7월 주택담보상품 투자 이벤트</li>
			</ul>
		
		</div>
		<div class="m_event5">
			<p class="m_event_num">#이벤트 1</p>
			<p>7월 오픈 [주택담보상품]에<br>누적 500만원 이상 투자 시<br><span>국산 덴탈 마스크 1 Box(50매) 증정</span></p>
		</div>
		<div class="m_event5">
			<p class="m_event_num">#이벤트 2</p>
			<p>7월 오픈 [주택담보상품]에<br>누적 1,000만원 투자 시<br><span>국산 덴탈 마스크 1 Box(50매) 추가 증정</span></p>
		</div>

		<div class="m_event9">
			<ul>
				<li class="m_title">참여기간</li>
				<li class="m_text">2020년 07월 01일 ~ 2020년 07월 31일</li>
			</ul>
		</div>
		<div class="m_event9">
			<ul>
				<li class="m_title">참여방법</li>
				<li class="m_text">7월 오픈 <span>주택담보상품</span>에 500만원 ~ 1,000만원 투자 시 자동 참여</li>
			</ul>
		</div>		
		<div class="m_event7">
			<ul>
