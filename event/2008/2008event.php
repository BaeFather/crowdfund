...
<link href="2008event.css" rel="stylesheet">
...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		...
		<div class="event2">헬로펀딩 8월 친구초대 이벤트</div>
		<div class="event3"><img src="img/banner.jpg" alt="헬로펀딩 8월 친구초대 이벤트"></div>
		<div class="event4" id="event1">친구초대 이벤트 </div>
		<div class="event5">추천한 친구가 <span>주택담보상품</span>에 투자 시 예치금 <span>5,000원씩 무제한 지급! </span><br>가입한 친구에겐 <span>예치금 5,000원</span></div>
		<div class="event6">
			<ul>
				<li class="title">참여방법</li>
				<li class="text">이벤트 기간 동안 초대한 친구가 회원가입 후 <span>주택담보상품</span>에
		...
		<div class="event9">
			<ul>
				...
				<li class="text">2020년 09월 10일 이내 일괄 지급</li>
			</ul>
		</div>
		...
		<div class="event17">				
				...
				<p>· 친구초대 이벤트의 경우, 2020년 08월 01일 이후 가입하고 2020년 08월 31일까지 투자를 완료한 친구 수를 기준으로 이벤트가 진행되며, <br>
					 <span>투자를 취소할 경우 지급되지 않습니다.</span></p>
				<p>· 이벤트 기간 동안 주택담보상품에 누적 투자액 100만원 이상 투자 시에만 적용됩니다.</p>
				<p>· 헬로펀딩 사이트를 통해 투자 시 이벤트 대상이 되며 핀크, 올리고, 기타제휴광고 등을 통한 투자는 제외됩니다.</p>
...
<!--------------------모바일----------------------------------------------------------->
	...
	<div id="event_m">
		...
		<div class="m_event2">헬로펀딩 8월 친구초대 이벤트</div>
		<div class="m_event3"><img src="img/m_banner.jpg" alt="헬로펀딩 8월 이벤트">
		...
		<div class="m_event5">추천한 친구가 <span>주택담보상품</span>에 투자시<br>예치금 <span>5,000원씩 무제한 지급! </span><br>가입한 친구에겐 <span>예치금 5,000원</span></div>
		<div class="m_event6">
			<ul>
				<li class="m_title">참여방법</li>
				<li class="m_text">이벤트 기간 동안 초대한 친구가 회원가입 후 <br><span>주택담보상품</span>에
                               <span>누적 투자액 100만원 이상</span><br> 투자 완료시 친구도 나도 자동 참여</li>
			</ul>
		</div>
		...
		<div class="m_event9">
			<ul>
				...
				<li class="m_text">2020년 09월 10일 이내 일괄 지급</li>
			</ul>
		</div>
		...
		<div class="m_event17">				
				...
				<p class="notice dot color">친구초대 이벤트의 경우, 2020년 08월 01일 이후 가입하고 2020년 08월 31일까지 투자를 완료한 친구 수를 기준으로 이벤트가 진행되며,
					 투자를 취소할 경우 지급되지 않습니다.</p>
				<p class="notice dot color">이벤트 기간 동안 주택담보상품에 누적 투자액 100만원 이상 투자 시에만 적용됩니다.</p>
				<p class="notice dot color">헬로펀딩 사이트를 통해 투자 시 이벤트 대상이 되며 핀크, 올리고, 기타제휴광고 등을 통한 투자는 제외됩니다.</p>
