...
<div id="content">
	...
	<div id="event">
		...
		<div class="event2">헬로펀딩 2020년 11월 첫 투자 이벤트</div>
		<div class="event3"><img src="img/banner.jpg" alt="헬로펀딩 2020년 11월 첫 투자 이벤트"></div>

		<div class="event5">첫 투자로 부동산, 주택담보 상품에 10만원 이상 투자 시<br><span>스타벅스 아메리카노 쿠폰 지급</span></div>
		<div class="event6">
			<ul>
				<li class="title">참여방법</li>
				<li class="text">이벤트 기간 내 <span>부동산, 주택담보 상품에 첫 투자금 10만원 이상</span> 투자완료 시 자동 참여</li>
			</ul>
		</div>
		<div class="event8">
			<ul>
				<li class="title">참여대상</li>
				<li class="text">2020년 10월 31일까지 투자 이력이 없는 기존회원 및 신규회원</li>
			</ul>
		</div>
		<div class="event8">
			<ul>
		...
		<div class="event17">				
				...
				<p>· 헬로펀딩 투자상품군 중 투자이력이 있는 회원은 이벤트 대상이 아닙니다. </p>
...
<div id="content_m">
	...
	<div id="event_m">
		...
		<div class="m_event2">헬로펀딩 11월 첫 투자 이벤트</div>
		<div class="m_event3"><img src="img/m_banner.jpg" alt="헬로펀딩 2020년 11월 첫 투자 이벤트">

		</div>
		<div class="m_event5">첫 투자로 부동산, 주택담보 상품에<br>10만원 이상 투자 시<br><span>스타벅스 아메리카노 쿠폰 지급</span></div>
		<div class="m_event6">
			<ul>
				<li class="m_title">참여방법</li>
				<li class="m_text">이벤트 기간 내 <span>부동산, 주택담보 상품에<br>첫 투자금 10만원 이상</span> 투자완료 시 자동 참여</li>
			</ul>
		</div>
		<div class="m_event8">
			<ul>
				<li class="m_title">참여대상</li>
				<li class="m_text">2020년 10월 31일까지 투자 이력이 없는<br>기존회원 및 신규회원</li>
			</ul>
		</div>
		<div class="m_event8">
			<ul>
		...
		<div class="m_event17">				
				...
				<p class="notice dot color">헬로펀딩 투자상품군 중 투자이력이 있는 회원은 이벤트 대상이 아닙니다. </p>
