...
<div id="content">
	...
	<div>
	  ...
	  <div id="event">
			<div class="event box1"><img src="./img/1event_01_2.jpg" alt="친구초대·첫투자 이벤트"></div>
			<div class="event box2">
				<div>

					<ul>
						<li><img src="./img/1event_05.png" alt="EVENT1"></li>
						<li class="atext"><a href="#event1">초대한 친구가 100만원 이상 투자하면 <br><span> 너도 나도 예치금 5,000원 지급 </span></a></li>
						<li class="arrow"><img src="./img/arrow.png" alt="바로가기 "></li>
					</ul>

					<ul class="line"><li></li></ul>

					<ul>
						<li><img src="./img/1event_06.png" alt="EVENT2"></li>
			...
			<div class="event box4"><P class="titleA">초대한 친구가 100만원 이상 투자하면</P><P class="titleB">친구도, 나도 예치금 5,000원씩!</P></div>
			<div class="event box5">
				<ul>
					<li class="sub">참여방법</li>
					<li class="btext">이벤트 기간 동안 초대한 친구가 회원가입 후 부동산, 주택담보 상품에 <span>누적 투자액 100만원 이상</span> 투자 완료시 <Br> 친구도 나도 자동 참여</li>
				</ul>
			</div>
			<div class="event box6">
				<div>
					<ul>
						<li><img src="./img/1event_01_3_A.jpg" alt="참여방법1"></li>
						<li class="step">회원가입시 추천인 ID 입력하기</li>
						<li class="stepw">친구가 회원가입시 추천인 ID에 <span>내 아이디를 입력</span> 후 <br>회원 가입을 완료합니다.</li>
					</ul>
					<ul>
						<li><img src="./img/1event_01_3_B.jpg" alt="참여방법2"></li>
						<li class="step">100만원 이상 투자하기</li>
						<li class="stepw">회원가입한 친구가  <span>부동산, 주택담보 상품</span>에 <br> <span>100만원 이상</span> 투자합니다.</li>
					</ul>
					<ul class="last">
						<li><img src="./img/1event_01_3_C.jpg" alt="참여방법3"></li>
			...
			<div class="event box11">
			  <P class="titleA">첫 투자로 누적 투자액 100만원 이상 투자시</P><P class="titleB">스타벅스 아메리카노 쿠폰 지급!</P></div>
			<div class="event box12">
				<ul>
					<li class="sub">참여방법</li>
					<li class="wtext">이벤트 기간 동안 부동산, 주택담보 상품에 <span>누적 투자액 100만원 이상</span> 투자 완료시 친구도 나도 자동 참여</li>
				</ul>
			</div>
			...
			<div class="event box15">
				...
				<p>· 본 이벤트는 이벤트 기간 내 회원가입 시 친구초대 아이디 입력, 누적 투자액 50만원 이상 투자 완료 시 자동응모 됩니다. </p>
