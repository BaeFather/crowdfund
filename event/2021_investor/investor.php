...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		...
		<div class="con_wrap"> 
			...
			<map name="Map1">
                <area shape="rect" coords="332,998,826,1079" href="https://www.hellofunding.co.kr/investment/investor/?tab=2" onFocus="blur()">
              </map>
			</div>
				
			<div><img src="img/web_tab_02_con.jpg" usemap="#Map">
              <map name="Map">
                <area shape="rect" coords="327,780,822,860" href="https://www.hellofunding.co.kr/care_service/request.php" onFocus="blur()">
              </map>
			</div>
		</div>
