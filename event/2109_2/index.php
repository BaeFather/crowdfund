...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		...
		<div class="event_title">헬로펀딩 2021년 09월 친구초대 이벤트</div>
		<div><img src="img/banner.jpg" alt="헬로펀딩 9월 친구초대 이벤트"></div>
		...
		<div class="event_notice_text">				
				...
				<p>· 2021년 09월 01일 이후 가입하고 2021년 09월 30일까지 투자를 완료한 친구 수를 기준으로 이벤트가 진행되며, 투자를 취소할 경우 지급되지 않습니다.</p>
				<p>· 참여 기간 동안 주택담보 상품에 누적 투자액 100만원 이상 투자 시에만 적용됩니다.</p>
				<p>· 헬로펀딩 사이트를 통해 투자 시 이벤트 대상이 되며 기타제휴광고 등을 통한 투자는 제외됩니다.</p>
...
<!--------------------모바일----------------------------------------------------------->
	...
	<div id="event_m">
		<div class="event_ing">진행중 이벤트<span>2021.09.01 ~ 2021.09.30</span></div>
		<div class="event_title">헬로펀딩 9월 친구초대 이벤트</div>
		<div><img src="img/m_banner.jpg" alt="헬로펀딩 9월 친구초대 이벤트"></div>
		...
		<div class="event_notice_text">				
				...
				<p class="notice dot color">2021년 09월 01일 이후 가입하고 2021년 09월 30일까지 투자를 완료한 친구 수를 기준으로 이벤트가 진행되며,
