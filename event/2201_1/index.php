...
<div id="content">
	...
	<div id="event">
		<div class="event_ing">주택담보 상품 투자이벤트<span><?=$s_date?> ~ <?=$e_date?></span></div>
		...
		<div class="event_notice_text">				
			    <p>· 본 이벤트는 참여 기간 내 해당 상품에 누적 500만원 이상 투자 완료 시 상품이 지급됩니다.</p>
				<p>· 투자한 상품이 이자상환 중으로 상태가 변경되면 자동 참여가 완료됩니다.</p>
...
<div id="content_m">
	...
	<div id="event_m">
		...
		<div class="event_notice">꼭! 읽어주세요. </div>
		<div class="event_notice_text">				
			    <p class="notice dot color">본 이벤트는 참여 기간 내 해당 상품에 누적 500만원 이상 투자 완료 시 상품이 지급됩니다.</p>
