...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		...
		<div class="con_wrap"> 
			<div><img src="img/web_tab_01_con.jpg"></div>
			<div><img src="img/web_tab_02_con.jpg" usemap="#Map">
              <map name="Map">
                <area shape="rect" coords="329,838,824,918" href="https://www.hellofunding.co.kr/care_service/request.php" onFocus="blur()">
              </map>
			</div>
		</div>
...
<!--------------------모바일----------------------------------------------------------->
	...
	<div id="event_m">
		...
		<div class="m_event17">				
			    <p class="notice dot color">이벤트 기간 내에 전문투자자/법인회원으로 가입/전환 후 첫 투자까지 완료 시에만 상품이 지급됩니다. (소상공인확정매출채권 상품 제외)</p>
