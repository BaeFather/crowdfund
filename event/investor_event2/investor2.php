...
if( date('Y-m-d') < $event_start_date ) {
	...
	$join_link = ($member['mb_no']) ? "javascript:alert('죄송합니다. 소득적격투자자 이벤트입니다.');" : "/member/join_info.php?tab=p";
}
...
<!--------------------웹----------------------------------------------------------->
	...
	<div id="event">
		<div class="event1">헬로펀딩 소득적격투자자 첫투자 이벤트<span><?=$s_date?> ~ <?=$e_date?></span></div>
		<div class="event3"><img src="img/web2_01.jpg" alt="헬로펀딩 소득적격투자자 이벤트"></div>

		<div class="event4_2">
			<div><img src="img/web2_02_title.jpg"></div>
			<div class="event_date">
				<ul>
					<li class="sub">참여기간</li>
					<li class="text"><?=$s_ymd?> ~ <?=$e_ymd?></li>
				</ul>
			</div>
			<div class="event_how">
				<ul>
					<li class="sub">참여방법</li>
					<li class="text">참여 기간 내 소득적격 투자자로 가입/전환 후<br>
		...
		<div class="event5"><img src="img/web2_03.jpg" alt="헬로펀딩 소득적격투자자 투자한도"></div>
		<div class="event5"><img src="img/web2_04.jpg" alt="헬로펀딩 소득적격투자자 변경방법" usemap="#Map">
			<map name="Map">
                <area shape="rect" coords="329,1140,824,1220" href="https://www.hellofunding.co.kr/investment/investor/" onFocus="blur()">
            </map>
		
	  </div>
		<div class="event6"><img src="img/web2_05.jpg" alt="헬로펀딩 소득적격투자자 유의사항"></div>
...
<!--------------------모바일----------------------------------------------------------->
	...
	<div id="event_m">
		<div class="m_event1">소득적격투자자 첫투자 이벤트<span><?=$s_date?> ~ <?=$e_date?></span></div>
		<div class="m_event3"><img src="img/mobile_bn2.jpg" alt="헬로펀딩 소득적격투자자 이벤트">
		...
		<div class="m2_event5">헬로펀딩 소득적격 투자자 가입<br>또는 전환 후 주택담보상품에<br> 100만원 이상 누적 투자 완료 시<br>
		<span>신세계상품권 3만원 지급</span></div>
		<div class="m_event6">
			<ul>
				<li class="m_title">참여대상</li>
				<li class="m_text">참여 기간 내 소득적격 투자자로<br>가입/전환 후 주택담보 상품에<br>100만원 이상 누적 투자 완료 시<br>자동 참여<br>
(부동산, 소상공인확정매출채권 상품 제외)</li>
			</ul>
		</div>
		<div class="m_event8">
			<ul>
				<li class="m_title">참여기간</li>
				<li class="m_text"><?=$s_ymd?> ~ <?=$e_ymd?></li>
			</ul>
		</div>
		<div class="m_event9">
			<ul>
		...
		<div><img src="img/mobile_compare2.jpg" alt="투자자 한도 비교"></div>
		...
		<div>
		<img src="img/m2_con.jpg">
			<a href="https://www.hellofunding.co.kr/investment/investor/"><img src="img/bt01.jpg"></a>
		</div>

	
		<div class="m_event16">꼭! 읽어주세요. </div>
		<div class="m_event17">				
			    <p class="notice dot color">참여 기간 내 소득적격 투자자로 가입/전환 후 해당 상품에 누적 100만원 이상 투자 완료 시에만 상품이 지급됩니다. (갱신 회원은 지급 대상에 포함되지 않습니다.)</p>
