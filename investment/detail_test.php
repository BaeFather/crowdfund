...
$special_user = ($is_admin=='super' || in_array($member['mb_id'], array('akorea','yr4msp','hellosiesta','sori9th','hellofunding','test070','test999'))) ? true : false;
...
// 지정투자상품 설정
if( in_array($prd_idx, array('148','157')) ) {
	if($prd_idx=='148') {
...
$(document).ready(function(){
	...
	$("#btn_invest").click(function(evt){
		...
		*/
		...
		//alert("회원님의 투자한도가 초과되어 더 이상 투자를 진행하실 수 없습니다.\n투자스케쥴러를 참조하십시요.");
			alert("투자 가능 금액이 없습니다.");
			return;
		}
