		...
		success: function(data) {
			...
			if(data=="SUCCESS" || data=="SUCCESS-ADVANCE-INVEST") {
				...
				*/
				...
				if(data=="ERROR-DATA")                       { alert("처리가 지연되고 있습니다. 잠시 후 다시 실행하여 주십시요."); }
...
<?
if ($member['mb_id']=="romrom") {
	//$aabc = get_p2pctr_limit($member['mb_id'], $prd_idx);
	//echo "<pre>"; print_r($aabc); echo "</pre>";
}
?>
