...
switch($CA) {
	...
	case 'C'  : $CATEGORY = array('id'=>'CAC',   'title'=>'헬로페이', 'guide_image_a'=>'/images/investment/ca_ban_tit05_m.jpg', 'guide_image_b'=>'/images/investment/ca_ban05_m.jpg'); break;
...
?>
		...
		<div class="clearfix">
			<div id="<?=$CATEGORY['id']?>" title="<?=$CATEGORY['title']?>">
				...
				<p class="hide" <?=($_COOKIE['tImgShow'])?'style="display:block;"':'style="display:none;"';?>><img src="<?=$CATEGORY['guide_image_b']?>" width="100%"></p>
			</div>
		</div>
		<!-- 카테고리 타이틀/설명 -->
