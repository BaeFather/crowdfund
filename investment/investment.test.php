...
if(G5_IS_MOBILE) {
	if($prd_idx <= 244) {
		...
		include_once('./investment.test.m.php');
	}
	return;
}
else {
...
add_stylesheet('<link rel="stylesheet" type="text/css" href="/investment/css/investment_info.css?ver=20220531_3">', 0);
...
$(document).ready(function() {
	...
	function ajax_investment(mb_id_js) {
			...
			$.ajax({
				type: "POST",
				url: "https://ext.hellofunding.co.kr/investment/ajax_investment.php",
				dataType: "json",
