...
<link rel="stylesheet" type="text/css" href="/theme/blueman1/css/frame_layout_mobile.css">
<link rel="stylesheet" type="text/css" href="/theme/blueman1/css/main_layout_mobile.css">
<link rel="stylesheet" type="text/css" href="/theme/blueman1/css/popup_mobile.css">
<link rel="stylesheet" type="text/css" href="/theme/blueman1/css/flexslider_mobile.css">
...
//-->
		...
		<div class="tabArea">
			...
			?>
				...
				<div class="invest_info">
					...
					<div class="notes">
						...
						<!--<? if($invest_finished==false) { ?><a href="./simulation.php?prd_idx=<?=$PRDT["idx"]?>" target="_self" class="btn_big_blue">투자 수익 시뮬레이션</a><? } ?>-->
					</div>
				</div>
			<?
			}
			?>
				...
				<? if($PRDT['extend_7']) { ?>
				<h3>투자관련 도움말</h3>
				<div class="point invest_info">
					<?
					if($PRDT['extend_7']) {
						$extend_7 = preg_replace("/_blank/i", "_self", $PRDT['extend_7']);
						$extend_7 = preg_replace("/(href=\"#\"|href='#')/i", "href='javascript:;'", $extend_7);
						echo $extend_7;
					}
					?>
				</div>
			...
			<div class="tabArea" style="padding-top:20px;">
				...
				<div class="point">
					<?
					if($PRDT['extend_9']) {
						$extend_9 = preg_replace("/_blank/i", "_self", $PRDT['extend_9']);
						$extend_9 = preg_replace("/(href=\"#\"|href='#')/i", "href='javascript:;'", $extend_9);
						echo $extend_9;
					}
					else {
						echo '<p style="text-align:center;color:#aaa">내용이 없습니다.</p>';
					}
					?>
				</div>
			</div>
			...
			<div class="tabArea" style="padding-top:20px;">
				...
				<div class="point">
					<?
					if($PRDT["extend_8"]) {
						$extend_8 = preg_replace("/_blank/i", "_self", $PRDT['extend_8']);
