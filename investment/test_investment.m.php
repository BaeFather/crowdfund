...
<? add_stylesheet('<link rel="stylesheet" type="text/css" href="/investment/css/investment_info_m.css?ver=20220328_2">', 0); ?>
...
$(document).ready(function() {
	...
	function ajax_investment(mb_id_js) {
		...
		$.ajax({
			...
			type: "POST",
			url: "<?=API_URL?>/investment/test_ajax_investment.php",
			dataType: "json",
