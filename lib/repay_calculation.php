...
function repayCalculation($product_idx, $invest_member_id='', $invest_period='', $loan_start_date='', $loan_end_date='', $invest_usefee='', $invest_usefee_type='') {
	...
	// 상환 계산 차수
	/*
	if($PRDT['invest_period']==1 && $PRDT['invest_days']>0) {		// 1개월 미만 상품
		$INI['calc_count'] = 1;
	}
	else {
...
*/
	...
	//print_rr($PRDT, 'font-size:11px;color:red');
	//print_rr($INI, 'font-size:11px;color:red');
	//print_rr($INVEST, 'font-size:11px;color:red');
	//print_rr($MTOTAL_INVEST_SUM, 'font-size:11px;color:red');
	//print_rr($REPAY, 'font-size:11px;color:red');
	//print_rr($REPAY_SUM, 'font-size:11px;color:blue');
