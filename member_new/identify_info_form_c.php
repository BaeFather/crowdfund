<?
###############################################################################
## [기존회원] 법인 회원 확인  ->  step 1 ~ 마지막 완료 단계까지
###############################################################################
...
<div id="content" class="identify-wrap">
	<div class="content">
		...
		<div class="confirm_form">
			...
			<form name="frmIdenInfoC" id="frmIdenInfoC" class="f-identify-c" method="post" enctype="multipart/form-data">
				<fieldset>
					<div class="top-title">
						<h2>법인회원 확인</h2>
						<div class="page-num">
...
<!-- step1 start -------------------------------------------------------------->
					<section>
						...
						<input type="text" id="mb_co_name" name="mb_co_name" value="<?=$member['mb_co_name']?>" onKeyUp="stringCheck('mb_co_name','name');" autocomplete="off" disabled>
						<span id="mb_co_name_error" class="error-block"></span>

						<label for="mb_co_reg_num1">사업자등록번호</label>
						<div class="m-layout">
							<input type="text" class="mb_co_reg_num" id="mb_co_reg_num1" name="mb_co_reg_num1" autocomplete="off" maxlength="3" onKeyUp="onlyDigit(this);fn_mb_co_reg_check();if($('#mb_co_reg_num1').val().length=='3'){$('#mb_co_reg_num2').focus();}" class="clear_text" disabled>
							<input type="text" class="mb_co_reg_num" id="mb_co_reg_num2" name="mb_co_reg_num2" autocomplete="off" maxlength="2" onKeyUp="onlyDigit(this);fn_mb_co_reg_check();if($('#mb_co_reg_num2').val().length=='2'){$('#mb_co_reg_num3').focus();}" class="clear_text" disabled>
							<input type="text" class="mb_co_reg_num" id="mb_co_reg_num3" name="mb_co_reg_num3" autocomplete="off" maxlength="5" onKeyUp="onlyDigit(this);fn_mb_co_reg_check();" disabled style="margin: 0;">
						</div>
						...
						<div class="m-layout">
							<input type="text" id="mb_co_enroll_num1" name="mb_co_enroll_num" autocomplete="off" class="clear_text">
							<input type="text" id="mb_co_enroll_num2" name="mb_co_enroll_num" autocomplete="off" class="clear_text">
						</div>
						<span class="error-block"></span>
						...
						<div class="input-box m-layout">
							...
							<input type="button" onclick="execDaumPostcode()" class="add-search" value="주소검색">
						</div>
						...
						<button type="button" class="btn_big_blue fn-next">다음</button>
					</section>
<!-- step1 end --------------------------------------------------------------->
...
<!-- step2 start ------------------------------------------------------------->
					<section style="display: none;">
						...
						<input type="text" id="cmb_name" name="cmb_name" class="" placeholder="대표자 실명 입력">
						<span class="error-block"></span>

						<label for="mb_eng_name">대표자 영문명</label>
						<span class="help-block">(영문 입력 필수)</span>
						<div class="input-box m-layout">
							<input type="text" name="eng_name" id="eng_name1" class="" placeholder="이름">
							<input type="text" name="eng_name" id="eng_name2" class="" placeholder="성">
						</div>
						<span class="error-block"></span>
						...
						<div class="input-box m-layout">
							...
							<input type="button" onclick="execDaumPostcode2()" class="add-search" value="주소검색">
						</div>
						...
						<input type="checkbox" name="is_info_same" id="is_info_same" value="Y" onclick="infoSame();"><label for="is_info_same" class="is_info_same"><span>대표정보 동일</span></label>
						<input type="text" id="mb_name" name="mb_name" onKeyUp="stringCheck('mb_name','00email');" class="">
						<span class="error-block"></span>

						<label for="mb_hp">담당자 연락처</label><br>
						...
						<ul class="btn-prev-next m-layout">
							<li class="m-prev-layout"><button type="button" class="btn-prev fn-prev">이전</button></li>
							<li class="m-next-layout"><button type="button" class="btn-next fn-next">다음</button></li>
						</ul>
					</section>
<!-- step2 end --------------------------------------------------------------->
...
<!-- step3 start ------------------------------------------------------------->
					<section style="display: none;">
						...
						<div class="filebox_c m-layout">
							<input type="file" id="file">
							<input class="upload-name name1" placeholder="선택된 파일 없음" readonly>
							<label for="file">파일선택</label>
						</div>
						<div class="filebox_c m-layout">
							<input type="file" id="file2">
							<input class="upload-name name2" placeholder="선택된 파일 없음" readonly>
							<label for="file2">파일선택</label>
						</div>
						<div class="filebox_c m-layout">
							<input type="file" id="file3">
							<input class="upload-name name3" placeholder="선택된 파일 없음" readonly>
				...
				-->
						...
						<ul class="bottom-btn-box m-layout">
							<li class="m-btn-prev pc-btn-prev"><button type="button" class="btn-prev fn-prev">이전</button></li>
							<li class="m-btn pc-btn"><button type="button" class="btn-success" id="submit_button" onClick="go_submit();">확인</button></li>
						</ul>
...
<!-- step3 end --------------------------------------------------------------->
			...
			<!-- step4 start -->
			<div class="cmb-exist-ok" style="display: none;">
				<div class="info-txt">
					<h3>법인확인 서류 제출 완료</h3>
					<p class="txt">
						제출하신 서류를 관리자가 검토 후<br />
						법인회원 확인이 완료되며 이후 기존 서비스 이용이 가능합니다.<br />
						<br />
						영업일 기준 1~3일 정도 소요됩니다.
					</p>
					<img src="../../theme/2018/img/member/step02_5_2.jpg" alt="step" class="img-process"/>
					<button type="button" class="btn-main btn-main-mg2" onclick="location.href=''">메인으로 가기</button>
				</div>
			</div>
			<!-- step4 end -->
