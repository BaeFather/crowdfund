<!-- 종무식 업무시간안내 팝업 20161229 ~ 20170101-->
<style>
<? if(G5_IS_MOBILE) { ?>
...
<div id="popup">
	...
	<div style="width:100%;"><img src="/images/main/popup/lastmonth<?=(G5_IS_MOBILE)?'_m':''?>.jpg" style="width:100%;"></div>
...
$(document).ready(function() {
	if(get_cookie('popupOpen')==false) {
		$.blockUI({
			message: $('#popup'),
			<? if(G5_IS_MOBILE) { ?>
			css: { top:'10%',left:'1%',width:'98%', border:0, cursor:'default' }
			<? } else { ?>
