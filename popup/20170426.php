...
<div id="popup">
	...
	<div style="width:100%;"><a href="/event/invest_review_20170426.php" target="_blank" /><img src="/popup/images/20170426.jpg" style="width:100%;"></a></div>
...
$(document).ready(function() {
	if(get_cookie('popupOpen')==false) {
		$.blockUI({
			message: $('#popup'),
			<? if(G5_IS_MOBILE) { ?>
			css: { top:'2%',left:'5%',width:'90%', border:0, cursor:'default' }
			<? } else { ?>
			css: { top:'15%',left:'10%',width:'485px', border:0, cursor:'default' }
			<? } ?>
		});
	}
});
