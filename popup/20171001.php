...
<div id="popup">
	...
	<div style="width:100%;"><img src="/popup/images/fall171001.jpg" style="width:100%;"></div>
...
$(document).ready(function() {
	if(get_cookie('popupOpen')==false) {
		$.blockUI({
			message: $('#popup'),
			<? if(G5_IS_MOBILE) { ?>
			css: { top:'2%',left:'3%',width:'93%', border:0, cursor:'default' }
			<? } else { ?>
			css: { top:'15%',left:'36%',width:'650px', border:0, cursor:'default' }
			<? } ?>
		});
	}
});
