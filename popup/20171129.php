...
<div id="popup">
	...
	<div style="width:100%;"><a href="/event/join_event171129.php"><img src="/images/event/join_event_popup.jpg" style="width:100%;"></a></div>
...
$(document).ready(function() {
	if(get_cookie('popupOpen')==false) {
		$.blockUI({
			...
			<? } else { ?>
			css: { top:'10%',left:'33%',width:'640px', border:0, cursor:'default' }
			<? } ?>
		});
	}
});
