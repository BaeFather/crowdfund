<?
$intime = (date('YmdHi') >= 202008122100 && date('YmdHi') < 202008122300) ? true : false;
...
<div id="popup">
	...
	<div style="width:100%;"><img src="/popup/images/notice20200812.jpg" style="width:100%;"></div>
...
$(document).ready(function() {
	if(get_cookie('popupOpen')==false) {
		$.blockUI({
			...
			<? } else { ?>
			css: { top:'15%',left:'33%',width:'640px', border:0, cursor:'default' }
			<? } ?>
		});
	}
});
