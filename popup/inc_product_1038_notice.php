	...
	<style>
	<? if(G5_IS_MOBILE) { ?>
	#product_notice { display:none; position:relative; width:100%; text-align:left; background-color:none;}
	...
	<? } else { ?>
	#product_notice { display:none; position:relative; width:720px; text-align:left;  }
	...
	<div id="product_notice">
		...
		<div class="con" id="con"><img src="/images/popup/pop860.jpg" width="100%"></div>
	</div>
	<script>
