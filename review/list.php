...
<div id="content">
	...
	<div>
		...
		<div class="request-bt">
			<div class="interview-request" onclick="location.href='/review/review_event/review_2205.php'">투자후기 참여하기</div>
			<div class="interview-request-m" onclick="location.href='/review/review_event/review_2205.php'"><img src="img/review_banner.jpg" alt="투자후기이벤트"></div>
