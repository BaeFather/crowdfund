...
.bt{margin:50px auto 100px; width:180px; height: 40px; border: 1px solid #222; border-radius: 50px; padding-top:6px; box-sizing: border-box;text-align:center;}
.bt a {color:#222; font-size:16px;}
