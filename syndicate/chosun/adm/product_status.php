...
$sql_search.= " AND (B.category<>3)";		// 확정 매출 채권은 땅집고에 노출되지 않는다.
$sql_search.= " AND (A.syndi_id='chosun')";		// 확정 매출 채권은 땅집고에 노출되지 않는다.
				...
				<div class="tabArea" style="display:block;padding:30px;border-left:1px solid #ccc; border-right:1px solid #ccc; border-bottom:1px solid #ccc;">
					...
					<table class="tblX">
						...
						<tr style="background-color:#EFEFEF">
							...
							<th scope="col" colspan="2" style="text-align:center;"><b>땅집고</b></th>
						</tr>
						<tr style="background-color:#EFEFEF">
