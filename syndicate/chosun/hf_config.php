...
if (HF_DOMAIN) {
    ...
    //if (isset($tmp_path['url'])) {
	/*
	if (isset($hf_path['url']))
		define('G5_URL', $hf_path['url']);
	else
		define('G5_URL', '');
	*/
	if (1>2) {
...
//define('G5_URL', 'https://dev.hellofunding.co.kr:4443');
define('G5_URL',        'http://chosun.hellofunding.kr');
define('BSC_URL',       HF_URL.'/syndicate/chosun');  //   /syndicate/chosun
...
// (!주의)세션저장경로
define('HF_SESSION_PATH', HF_DATA_PATH.'/session_chosun');
//define('HF_SESSION_PATH', HF_DATA_PATH.'/session');
