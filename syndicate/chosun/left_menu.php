		...
		if ($is_member) {
			?>
			<li class="login_btn"><a href="/member/logout.php">로그아웃</a></li>
			<?
		} else {
			?>
			<li>
				<p><a href="/member/login.php" class="login_btn">로그인</a></p>
				<p><a href="/member/join_info.php" class="join_btn">회원가입</a></p>
			</li>
