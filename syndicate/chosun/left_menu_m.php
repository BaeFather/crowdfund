...
?>
	...
	<div id="hd_wrapper">
		...
		<button type="button" id="gnb_open" class="hd_opener">
			<span class="sound_only2">메뉴열기</span>
		</button>
		...
		<div id="gnb" class="hd_div">
			...
			<ul  class="cho_leftmenu">
				...
				<li>투자상품보기
					<ul class="cl_m1">
						<li>- <a href="<?=BSC_URL?>/investment/invest_list.php">전체</a></li>
						<li>- <a href="<?=BSC_URL?>/investment/invest_list.php?CA=A">부동산</a></li>
						<li>- <a href="<?=BSC_URL?>/investment/invest_list.php?CA=A2">주택담보</a></li>
						<li>- <a href="<?=BSC_URL?>/investment/invest_list.php?CA=B">동산</a></li>
					</ul>
				</li>
				<li><a href="<?=BSC_URL?>/investment/guide.php">투자방법안내</a></li>
				<li><a href="<?=BSC_URL?>/etc/epilogue.php">투자후기</a></li>
				<li><a href="<?=BSC_URL?>/etc/faq.php">도움말</a></li>
				<li><a href="<?=BSC_URL?>/etc/question.php">문의하기</a></li>
			</ul>
...
<? } else { ?>
			<a href="<?=BSC_URL?>/member/login.php" id="user_login">로그인</a>
<? } ?>
