...
<? } else { ?>
<link rel="stylesheet" href="<?=HF_CSS_URL?>/style.css">
<? } ?>
...
<div id="content">
	...
	<?php if(false) { ?><!--<div class="location"><span></span><b class="blue">로그인</b></div>//--><?php } ?>
	

        <form name="flogin" action="/member/login_check.php" onsubmit="return flogin_submit(this);" method="post">
            ...
            <fieldset id="login_form">
                ...
                <div class="register_description">
                    ...
                    <?php if(false) { ?><!-- <span><a href="<?php echo G5_BBS_URL;?>/register_choice.php">회원가입</a></span> //--><?php } ?>
