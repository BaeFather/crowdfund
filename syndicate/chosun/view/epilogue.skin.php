...
?>
<? if(G5_IS_MOBILE) { ?>
<link rel="stylesheet" href="/css/epilogue_m.css">
<? } else { ?>
<link rel="stylesheet" href="/css/epilogue.css">
<? } ?>
...
/*
        ...
        <div class="review_best_list">
            <img src="<?=HF_URL?>/images/review/best_review_title.png" alt="BEST 투자후기" class="review_best_title"/>
                        ...
                        <div class="swiper-slide" style="width:360px;">
                            <div class="review">
                                <div class="review_box">
                                    ...
                                    <span class="mem_name"><?php echo $best["mem_name"].' (ID: '.$best["mem_id"].')';?></span>
                                    <div class="thumbnail">
                                        <img src="<?php echo $best["thumb_url"];?>" width="100%" height="310" alt="<?php echo $best['thumbnail_origin'];?>"/>
                                    </div>
                                    <span class="contents"><?php echo $best["contents"];?></span>
                                    <div class="link">
                                        <a href="<?php echo $best["target_link"];?>" target="_blank">자세히 보기</a>
                        ...
                        <li>
                            <div class="review">
                                <div class="review_box">
                                    ...
                                    <div class="thumbnail">
                                        <img src="<?php echo $review["thumb_url"];?>" width="100%" height="310" alt="<?php echo $review['thumbnail_origin'];?>"/>
                                    </div>
