...
<? } ?>
	...
	<table class="tblX">
		...
		<tr style="background-color:#F7F7F7;border-top:2px solid #284893;">
			<th rowspan="6" style="color:brown"><b>합계</b></th>
			<th rowspan="2" style="color:brown"><b>투자발생</b></th>
			<th style="height:20px;color:brown"><b>건수</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['invest_count'])?>건</th>
		</tr>
		<tr style="background-color:#F7F7F7;">
			<th style="height:20px;color:brown"><b>금액</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['invest_amount'])?>원</th>
		</tr>
		<tr style="background-color:#F7F7F7;">
			<th rowspan="2" style="color:brown"><b>원금상환</b></th>
			<th style="height:20px;color:brown"><b>예정</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['target_principal'])?>원</th>
		</tr>
		<tr style="background-color:#F7F7F7;">
			<th style="height:20px;color:brown"><b>지급</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['payed_principal'])?>원</th>
		</tr>
		<tr style="background-color:#F7F7F7;">
			<th rowspan="2" style="color:brown"><b>이자상환</b></th>
			<th style="height:20px;color:brown"><b>예정</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['target_interest'])?>원</th>
		</tr>
		<tr style="background-color:#F7F7F7;">
			<th style="height:20px;;color:brown"><b>지급</b></th>
			<th style="height:20px;text-align:right;color:#0000ff;"><?=number_format($TOTAL['payed_interest'])?>원</th>
		</tr>
<?
if(count($DATA)) {
	...
	for($i=0,$j=1; $i<count($DATA); $i++,$j++) {
		...
		$tr_bgcolor = ($j%2==0) ? "#F7F7F7" : "";

?>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td rowspan="6">
			...
			<td rowspan="2">투자발생</td>
			<td style="height:20px">건수</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['invest_count'])?'#000':'#bbb'?>"><?=number_format($DATA[$date]['invest_count'])?>건</td>
		</tr>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td style="height:20px">금액</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['invest_amount'])?'#000':'#bbb'?>"><?=number_format($DATA[$date]['invest_amount'])?>원</td>
		</tr>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td rowspan="2">원금상환</td>
			<td style="height:20px">예정</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['target_principal'])?'#000':'#bbb'?>"><?=$target_principal?>원</td>
		</tr>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td style="height:20px">지급</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['payed_principal'])?'#000':'#bbb'?>"><?=number_format($DATA[$date]['payed_principal'])?>원</td>
		</tr>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td rowspan="2">이자상환</td>
			<td style="height:20px">예정</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['target_interest'])?'#000':'#bbb'?>"><?=number_format($target_interest)?>원</td>
		</tr>
		<tr style="text-align:center;background-color:<?=$tr_bgcolor?>">
			<td style="height:20px;">지급</td>
			<td style="height:20px;text-align:right;color:<?=($DATA[$date]['payed_interest'])?'#000':'#bbb'?>"><?=number_format($DATA[$date]['payed_interest'])?>원</td>
		</tr>
<?
	}
}else {
