...
if( trim($_REQUEST['co_id']) == 'company' ) {
	header("Location: /company.php");
}

// 투자가이드 페이지 경로 변경 (2016-09-25 by sori9th)
if( trim($_REQUEST['co_id']) == 'funding_guide' ) {
	header("Location: /investment/guide.php");
}

// 이용약관 및 개인정보보호정책 경로 변경 (2016-06-28 by sori9th)
if( in_array($_REQUEST['co_id'], array('provision','privacy','marketing_agreement')) ) {
	header("Location: /etc/".$_REQUEST['co_id'].".php");
}
...
*/
$skin_file = HF_PATH."/view/content.skin.php";
