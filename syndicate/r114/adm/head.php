...
<? if( preg_match("/(product_detail|\/adm\/)/i", $_SERVER['PHP_SELF']) ) { ?>
<link rel="stylesheet" type="text/css" href="/adm/css/default<?=(G5_IS_MOBILE)?'_mobile':''?>.css">
<link rel="stylesheet" type="text/css" href="/adm/css/frame_layout<?=(G5_IS_MOBILE)?'_mobile':''?>.css">
<link rel="stylesheet" type="text/css" href="/adm/css/main_layout<?=(G5_IS_MOBILE)?'_mobile':''?>.css">
...
<? } else { ?>
<link rel="stylesheet" type="text/css" href="/theme/blueman1/css/main_layout<?=(G5_IS_MOBILE)?'_mobile':''?>_syndi.css">
<? } ?>
