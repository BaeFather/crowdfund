...
.tblX th { padding:4px 4px; border-left:1px solid #ccc; border-bottom:1px solid #ccc; text-align:center; font-family:'NGB'; font-size:1.1em; background-color:#F7F7F7; }
.tblX td { padding:4px 6px; border-left:1px solid #ccc; border-bottom:1px solid #ccc; text-align:left; font-family:'NG'; font-size:1.0em; }
...
?>
  <table class="tblX">
    ...
    <tr style="border-top:2px solid #284893;">
      <th style="background-color:#F7F7F7;">자동투자그룹</th>
