                    ...
                    <table width="611" align="center" border="0" style="border-collapse:collapse;" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <th height="40">
                                <table width="0" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <th width="220" class="font03" scope="col"><?=date("Y.m.d", strtotime($PRDT['loan_start_date']));?> ~ <?=date("Y.m.d", strtotime($PRDT['invest_end_date']));?></th>
                        ...
                        <tr>
                            ...
                            <th class="font03" scope="col">"<?=$PRDT['title'];?>"의 대출자</th>
                        </tr>
                        <tr>
                            <th height="40" class="font03" scope="col">수익증서 판매자</th>
                            <th class="font03" scope="col">(주)헬로크라우드대부</th>
                        </tr>
                    </table>
                </div>
