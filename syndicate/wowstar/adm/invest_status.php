...
//$sql_search.= " AND B.syndi_id='$syndi_id' ";
if($sym && $eym) {
	if($sym < $eym) {
					...
					<table class="tblX">
						<thead>
							<tr style="background-color:#EFEFEF">
								<th scope="col" style="width:25%;text-align:center;">Date</th>
								<th scope="col" style="width:25%;text-align:center;">가입자수</th>
								<th scope="col" style="width:25%;text-align:center;">투자건수</th>
								<th scope="col" style="width:25%;text-align:center;">투자금액</th>
							</tr>
						</thead>
						<tbody>
<?
