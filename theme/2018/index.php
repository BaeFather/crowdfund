...
/*
$NUJUK_CACHE['leftDayCount']        // 첫상품모집시작일 이후 현재까지의 일수
$NUJUK_CACHE['totalProductCount']   // 전체상품수(투자성공기준)
$NUJUK_CACHE['investAmount']        // 누적대출액
$NUJUK_CACHE['investCount']         // 누적투자건수
$NUJUK_CACHE['repayPrincipal']      // 누적상환원금
$NUJUK_CACHE['repayInterest']       // 누적상환이자
$NUJUK_CACHE['repayTotal']          // 누적상환액(원금+이자)
$NUJUK_CACHE['investIngAmount']     // 대출잔액
$NUJUK_CACHE['averageReturn']       // 평균수익률(연, 가중평균)
$NUJUK_CACHE['investSuccessCount']  // 투자성공건수
$NUJUK_CACHE['overduePerc']         // 연체율
$NUJUK_CACHE['bankruptcy']          // 부실율
$NUJUK_CACHE['averageInvMonth']     // 평균투자기간
$NUJUK_CACHE['averageInvAmount']    // 평균투자금액
*/
