...
<div class="invest_num">
	<ul>
		...
		<li>부실률<b id="bankruptcy-claim-mark" class="claim-mark">!</b><br><span class="counter"><?=floatRtrim($NUJUK_CACHE['bankruptcy'])?></span>%</li>
	</ul>
</div>
	...
	<ul class="product_list">
		<li>
			<a href="/investment/invest_list.php?CA=A2"><div>
				...
				<p class="text">LTV 85% 이하의 서울, 수도권, 주요 대도시의 주거용 부동산 담보</p>
...
<div class="interview roll">
	<ul class="box">
		<li><img src="<?=G5_THEME_IMG_URL?>/new/reviewer.png"></li>
		<li>
			<span>투자자 인터뷰</span>
			<p class="title">재테크는 선택이 아닌 필수</p>
			<p class="text">모두가 희망하는 직업, 건물주와 비슷한 방법을 찾다가 알게 된 P2P 투자. <br>
   		    투자 기간이 정해져있고 내가 투자한 금액에 대한 이자가 <br>
			매달 나오는 게 정말 매력적이었습니다.<br>
			헬로펀딩은 저에게 믿고 맡길 수 있는 은행 같은 존재인 것 같아요!
			</p>
			<a href="/review/?RD=2&S=1&SE=223"><bt>자세히 보기</bt></a>
		</li>
	</ul>
</div>
