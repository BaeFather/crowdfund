...
add_stylesheet('<link rel="stylesheet" type="text/css" href="'.$company_skin_url.'/style.test.css?ver='.time().'">', 0);
...
?>
				<li onClick="view_name('<?=$j?>');">
					<div class="member_m"><div id="amember_m_info<?=$j?>" class="member_m_info"><?=$sawon[$i][1]?><p><?=$sawon[$i][3]?></p></div></div>
...
?>
				<li style="padding-top:0;">
					<div class="member_m"><div class="member_m_info">미래의 주인공<p>헬로펀딩의 비전을 이해하고 함께할 수 있는 당신</p></div></div>
...
?>
		...
		<div class="blog_btn" onClick="window.open('http://blog.naver.com/PostList.nhn?blogId=hellofunding&from=postList&categoryNo=14')"><span>블로그 바로가기 클릭!</span><br/>더 많은 스토리는 블로그에서 확인하세요.</div>

		<!-- 기업연혁-->
			<p style="height:35px;clear:both;"></p>
			<img class="lazy" data-src="/images/company/comp_img12_m.jpg" width="100%">
			<ul class="tabs">
				<li class="tab01 on" rel="history_tab1"><a onClick="go_2020()" style="cursor:pointer;">2020</a></li>
				<li class="line">|</li>
				<li class="tab02 off" rel="history_tab1"><a onClick="go_2019()" style="cursor:pointer;">2019</a></li>
				<li class="line">|</li>
				<li class="tab03 off" rel="history_tab2"><a onClick="go_2018();" style="cursor:pointer;">2018</a></li>
				<li class="line">|</li>
				<li class="tab04 off" rel="history_tab3"><a onclick="go_2017();" style="cursor:pointer;">2017</a></li>
				<li class="line">|</li>
				<li class="tab05 off" rel="history_tab4"><a onclick="go_2016();" style="cursor:pointer;">2016</a></li>
			</ul>
