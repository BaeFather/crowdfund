...
//if($_REQUEST['event_id']=="100BEVENT2") { $login_url = urlencode("/event/quest.php"); }
	...
	<div class="content">
		...
		<form name="flogin" action="<?=$login_action_url;?>" onsubmit="return flogin_submit(this);" method="post">
			...
			<fieldset id="login_form">
				...
				<input type="text" name="mb_id" id="login_id" value="<?=$ck_save_id?>" required="required" autocomplete="off" class="textbox mb-id required" placeholder="아이디를 입력해주세요."><br>
				<div style="width:100%;text-align:right"><input type="checkbox" name="id_save" id="login_id_save" <?=($ck_save_id)?'checked':'';?>> <label for="login_id_save" style="color:#555;font-size:14px">아이디 저장</label></div>

				<label for="login_pw">비밀번호</label>
				<input type="password" name="mb_password" id="login_pw" required="required" autocomplete="off" class="textbox mb-pw required" placeholder="비밀번호를 입력해주세요."><br>
				...
				<div class="btn_group">
					<button type="submit" id="login_submit" class="btn_big_blue">로그인</button>
