...
<div id="new_ft">
		...
		<div id="ft_company">
			<div class="foot_wrap">
				<ul class="company_info">
					...
					<!--li><a href="<?=G5_URL?>/company/투자이용약관.pdf">투자이용약관</a></li-->
	...
	<div class="ft_company_info">
		<div class="contact">고객센터 : 1588-6760 <a href="http://pf.kakao.com/_xgAdWu" target="_blank"><img src="<?=G5_THEME_URL?>/img/new/kakao.png" alt="카카오톡 친구추가"/></a></div>
		<div class="cs_info">
		...
		<h3>(주)헬로핀테크</h3>
		<p style="line-height: 1.5;">대표 : 최수석 | 사업자번호 : 789-81-00529 <br> 온라인투자연계금융업 등록번호 : 2022-21 <br> 주소 : 서울시 강남구 대치동 945-10(테헤란로 98길 8) KT&G 대치타워 5층</p>
		<br>
