...
//add_stylesheet('	<link rel="stylesheet" href="'.$latest_skin_dir.'/style.css?ver=20190212" />', 0);
...
<div class="funding-news-list">
		...
		<div class="swiper-wrapper">
			...
			for ($i = 0; $i < count($list); $i++) {
				...
				<div class="swiper-slide content">
					...
					<div class="pull-left">
						<? if($list[$i]['news_logo']) { ?>
							<img src="<? echo $list[$i]['news_logo'];?>" alt="<? echo $list[$i]['subject'];?>" class="logo"/>
						<? } ?>
					</div>
	...
	<!--div class="swiper-button-next funding-news-button-next" onFocus="blur();"></div>
	<div class="swiper-button-prev funding-news-button-prev" onFocus="blur();"></div-->
</div>