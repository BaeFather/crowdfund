			...
			<div class="info">
				...
				<div class="comp1">
					...
					<ul class="sns2">
						...
						<li><a href="javascript:;" onClick="alert('모바일로 접속시 지원하는 기능입니다.');"><img src="<?=G5_THEME_URL?>/img/yellow_icon.png" alt="Yellow ID hellopunding"></a></li>
					</ul>
				...
				<div class="comp2">
					...
					<ul>
						<li><a href="http://p2plending.or.kr/" target="_blank"><img src="<?=G5_THEME_URL?>/img/b_logo01.png" width="70%"></a></li>
