...
<div class="quick_guide_area">
	<img id="quick_guide_btn" src="/images/guide.png" <?if(G5_IS_MOBILE){?>width="60"<?}?> style="opacity:0.9;cursor:pointer" alt="투자순서안내">
	<? if(!$is_member) { ?><img id="reqsms_btn" src="/images/reqsms_btn.png" <?if(G5_IS_MOBILE){?>width="60"<?}?> style="opacity:0.9;cursor:pointer" alt="투자상품알림받기"><? } ?>
</div>
