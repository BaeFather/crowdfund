    ...
    <!--<div id="reqsms" class="reqsms"><a href="#"><img src="<?=G5_URL?>/images/main/alarm_btn.png"></a></div>-->
		<div class="visualArea">
			<ul class="slider">
				...
				<li><a href="/event_invest/event_invest.php?prd_idx=4"><img src="<?=G5_URL?>/images/main/main_04_235event.jpg" alt="visual04" /></a></li>
			</ul>
		</div>
		<?
		...
		<ul class="info">
			...
			<li>펀딩성공<div><?=$invest_success_count?>건</div></li>
		</ul>
		<?
		}
		?>
...
?>
			<div class="box">
				...
				<div class="con">
					...
					<ul class="progress">
						<li>참여진행률<b class="blue"></b>
							<div class="rate"><img src="../images/investment/rate_blue.gif" alt="진행률" style="width:<?=($ALIST[$i]["INVEST_PERCENT"])?$ALIST[$i]["INVEST_PERCENT"]:0.2;?>%" /></div>
						</li>
					</ul>
