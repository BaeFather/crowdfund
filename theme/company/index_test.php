    ...
    <!--<div id="reqsms" class="reqsms"><a href="#"><img src="<?=G5_URL?>/images/main/alarm_btn.png"></a></div>-->
		<div class="visualArea">
			<ul class="slider">
				...
				<li><a href="/event_invest/event_invest.php?prd_idx=5"><img src="<?=G5_URL?>/images/main/main_04_235event.jpg" alt="visual04" /></a></li>
		...
		<!-- 비주얼 하단내용 -->
		<ul class="info">
			<li style="border:1px solid #ccc">평균수익률<div>(연)<?=$average_return?>%</div></li>
			<li style="border:1px solid #ccc">누적투자액<div><?=$total_invest?>원</div></li>
			<li style="border:1px solid #ccc">누적상환액<div><?=$total_repay?>원</div></li>
			<li style="border:1px solid #ccc">부도율<div><?=$bankruptc?>%</div></li>
			<li style="border:1px solid #ccc">펀딩성공<div><?=$invest_success_count?>건</div></li>
		</ul>
		<?
		}
		?>
