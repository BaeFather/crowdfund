...
<div id="content">
	...
	<div class="content">
		<div class="login" style="margin-top:10%;">
			...
			<div class="inputArea">
				<div class="id" style="text-align:left;"><?=$member['mb_id']?></div>
				<div class="pw"><input type="password" name="mb_password" id="mb_confirm_pw" required placeholder="비밀번호(필수)" maxLength="30" /></div>
			</div>
			<div class="btn_confirm">
				<input type="submit" value="확인" class="btn_big_blue" style="width:99.9%; border-radius:3px; margin-top:4px;">
				<a href="<?=G5_URL?>" class="btn_big_gray" style="width:99%; margin-top:4px;">메인으로 돌아가기</a>
			</div>
			</form>
