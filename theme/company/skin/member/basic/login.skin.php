				...
				<div class="loginType">
					...
					<div class="">
						...
						<div class="">
							...
							구글계정으로 로그인 합니다.<br>
							<a href="<?php echo $social_oauth_url.'google'; ?>" class="btn_link social_oauth" target="_blank">바로가기</a>
						</div>
					</div>
				 ...
				 페이스북 로그인하기
					<div class="">
						...
						<div class="">
							...
							페이스북계정으로 로그인 합니다.<br>
							<a href="<?php echo $social_oauth_url.'facebook'; ?>" class="btn_link social_oauth" target="_blank">바로가기</a>
						</div>
					</div>
